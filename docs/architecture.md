...
5. **Dependency-free interface:** Signal Desk uses a minimal function-first visual system and server-packaged static
   assets, avoiding a frontend build pipeline while keeping the prototype easy to demonstrate.
